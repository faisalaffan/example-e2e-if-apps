...
declare namespace manifestMethods {
     ...
     *                 application package.
     */
    function packageAndLaunchActivityFromManifest(appPath: string): Promise<APKInfo>;
    /**
     ...
     * @return {Promise<number>} The version of the target SDK.
     */
    function targetSdkVersionUsingPKG(pkg: string, cmdOutput?: string | null): Promise<number>;
    /**
     ...
     */
    function hasInternetPermissionFromManifest(appPath: string): Promise<boolean>;
}
