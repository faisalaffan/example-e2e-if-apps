...
declare namespace lockManagementMethods {
     ...
     */
    function isLockManagementSupported(): Promise<boolean>;
    /**
     ...
     */
    function verifyLockCredential(credential?: string | null): Promise<boolean>;
    /**
     ...
     */
    function clearLockCredential(credential?: string | null): Promise<void>;
    /**
     ...
     * @throws {Error} If operation faces an unexpected error
     */
    function isLockEnabled(): Promise<boolean>;
    /**
     ...
     * the credential
     */
    function setLockCredential(credentialType: string, credential: string, oldCredential?: string | null): Promise<void>;
    /**
     ...
     */
    function dismissKeyguard(): Promise<void>;
    /**
     ...
     */
    function cycleWakeUp(): Promise<void>;
}
