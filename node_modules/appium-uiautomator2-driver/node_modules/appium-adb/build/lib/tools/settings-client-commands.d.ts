...
declare namespace commands {
     ...
     */
    function requireRunningSettingsApp(opts?: SettingsAppStartupOptions): ADB;
    /**
     ...
     */
    function setWifiState(on: boolean, isEmulator?: boolean | undefined): Promise<void>;
    /**
     ...
     *                                       is an emulator rather than a real device.
     */
    function setDataState(on: boolean, isEmulator?: boolean | undefined): Promise<void>;
    /**
     ...
     * @param {boolean} on - True to enable and false to disable it.
     */
    function setAnimationState(on: boolean): Promise<void>;
    /**
     ...
     */
    function setDeviceSysLocaleViaSettingApp(language: string, country: string, script?: string | null): Promise<void>;
    /**
     ...
     *                                       is an emulator rather than a real device.
     */
    function setGeoLocation(location: Location, isEmulator?: boolean | undefined): Promise<void>;
    /**
     ...
     */
    function getGeoLocation(): Promise<Location>;
    /**
     ...
     */
    function refreshGeoLocationCache(timeoutMs?: number): Promise<void>;
    /**
     ...
     */
    function performEditorAction(action: string | number): Promise<void>;
    /**
     ...
     */
    function getNotifications(): Promise<import("@appium/types").StringRecord<any>>;
    /**
     ...
     */
    function getSmsList(opts?: SmsListOptions): Promise<SmsListResult>;
    /**
     ...
     */
    function typeUnicode(text: string): Promise<boolean>;
    /**
     ...
     */
    function scanMedia(destination: string): Promise<void>;
}
