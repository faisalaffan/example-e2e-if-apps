...
lockManagementMethods.isLockManagementSupported = async function isLockManagementSupported() {
    if (!lodash_1.default.isBoolean(this._isLockManagementSupported)) {
        ...
        logger_js_1.default.debug(`Extended lock settings management is ` +
...
lockManagementMethods.isScreenLocked = async function isScreenLocked() {
    ...
    return (0, helpers_js_1.isShowingLockscreen)(stdout)
        || (0, helpers_js_1.isCurrentFocusOnKeyguard)(stdout)
        || !(0, helpers_js_1.isScreenOnFully)(stdout);
};
/**
 * Dismisses keyguard overlay.
 */
lockManagementMethods.dismissKeyguard = async function dismissKeyguard() {
    logger_js_1.default.info('Waking up the device to dismiss the keyguard');
    ...
    if (!(0, helpers_js_1.isCurrentFocusOnKeyguard)(stdout)) {
        logger_js_1.default.debug('The keyguard seems to be inactive');
        return;
    }
    logger_js_1.default.debug('Swiping up to dismiss the keyguard');
    if (await this.hideKeyboard()) {
        await bluebird_1.default.delay(HIDE_KEYBOARD_WAIT_TIME);
    }
    logger_js_1.default.debug('Dismissing notifications from the unlock view');
...
exports.default = lockManagementMethods;
/**
