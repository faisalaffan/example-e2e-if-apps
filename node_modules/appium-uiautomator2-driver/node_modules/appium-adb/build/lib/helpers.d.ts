...
export type InstallOptions = {
    ...
    replace: boolean;
    /**
     * [false] - Install apks partially. It is used for 'install-multiple'.
 ...
 */
export function getAndroidPlatformAndPath(sdkRoot: any): PlatformInfo;
export function unzipFile(zipPath: any, dstRoot?: string): Promise<void>;
export function getIMEListFromOutput(stdout: any): any[];
export const getJavaForOs: (() => Promise<string>) & _.MemoizedFunction;
/**
 ...
 */
export function buildStartCmd(startAppOptions: StartAppOptions, apiLevel: number): Array<string>;
export const getJavaHome: (() => Promise<string>) & _.MemoizedFunction;
export const getSdkToolsVersion: (() => Promise<{
    major: number;
    minor: number;
    build: number;
} | undefined>) & _.MemoizedFunction;
/**
 ...
 */
export function getApksignerForOs(sysHelpers: Object): Promise<string>;
/**
 ...
 */
export const getBuildToolsDirs: ((sdkRoot: any) => Promise<string[]>) & _.MemoizedFunction;
/**
 ...
 * @throws {Error} If the tool is not present on the local file system.
 */
export function getApkanalyzerForOs(sysHelpers: Object): string;
 ...
 */
export function extractMatchingPermissions(dumpsysOutput: string, groupNames: Array<string>, grantedState?: boolean | null): Array<string>;
 ...
 */
export function buildInstallArgs(apiLevel: number, options?: InstallOptions | null): Array<string>;
 ...
 */
export function parseAaptStrings(rawOutput: string, configMarker: string): Object;
/**
 ...
 * given marker then an empty mapping is returned.
 */
export function parseAapt2Strings(rawOutput: string, configMarker: string): Object;
/**
 ...
 * as a valid JSON
 */
export function parseJsonData(output: string, entityName: string): Object;
/**
 ...
 * @returns {boolean}
 */
export function dirExists(location: string | null): boolean;
/**
 ...
 */
export function matchComponentName(classString: string): Array<Match> | null;
/**
