...
export declare const identSpecialChars: Record<string, boolean>;
export declare const strReplacementsRev: Record<string, string>;
export declare const stringEscapeChars: Record<string, string>;
...
export declare const escapePseudoClassString: (s: string) => string;
